        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-20">
            ...
            <div className="relative z-10 w-full max-w-lg">
                ...
                <div className="text-center mb-6">
                    ...
                    <h1 className="text-3xl font-bold font-heading text-white mb-3">Join GhostGram</h1>
                    <p className="font-text text-lg text-ghost-text-secondary">Create your anonymous profile</p>
                </div>
                ...
                <div className="glass rounded-3xl p-10 neon-border hover:border-ghost-accent/40 transition-all duration-300">
                    <form onSubmit={handleSignup} className="space-y-8">
                        ...
                        <div>
                            <label htmlFor="confirm-password" className="block text-sm font-semibold font-heading text-ghost-text mb-2">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <input
                    ...
                    <div className="text-center">
                        <p className="text-ghost-text-secondary text-lg">
                            ...
                            <Link href="/login" className="text-ghost-accent hover:text-cyan-400 font-semibold transition-colors duration-300 hover:underline block">
                                Sign in here
                            </Link>
                        </p>
                    </div>
